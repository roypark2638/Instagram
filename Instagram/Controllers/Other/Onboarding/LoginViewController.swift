...
class LoginViewController: UIViewController {
    ...
    // this approach creating a subview is called anonymous closure.
    ...
    private func configureHeaderView() {
        ...
        // Add instagram logo
        let imageView = UIImageView(image: UIImage(named: "instagram_logo"))
...
extension LoginViewController: UITextFieldDelegate {
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        ...
        // when user hits return with emailField, passwordField will get focused
        if textField == usernameEmailField {
            passwordField.becomeFirstResponder()
        }
        // when user hits return with passwordField, it will call loginButton
